...
export XIAOZHI_MCP_ENDPOINT=<xiaozhi_mcp_endpoint>
python mcp_pipe_common.py <mcp_script>
...
async def connect_to_server(uri):
    ...
    try:
        ...
        async with websockets.connect(uri) as websocket:
            ...
            cmd = mcp_script
            logger.info(f"Starting {mcp_script} process")
...
if __name__ == "__main__":
    ...
    # mcp_script
    if len(sys.argv) < 2:
        logger.error("Usage: mcp_pipe_common.py <mcp_script....>")
        sys.exit(1)
